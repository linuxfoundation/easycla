/*
 * Comprehensive test suite for all Template APIs in V3 (tagged with 'template' in swagger)
 *
 * Covers all HTTP methods for template endpoints:
 * - GET /template (authenticated)
 * - POST /clagroup/{claGroupId}/template (authenticated)
 *
