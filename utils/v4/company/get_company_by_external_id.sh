#!/bin/bash
# Get company by external ID (SFID) (authenticated)
# Usage: ./get_company_by_external_id.sh <company_sfid>
# Example: ./get_company_by_external_id.sh a01234567890123456
...
API="${API_URL}/v4/company/external/${company_sfid}"
