...
# Getprojectgitlabrepositories (authenticated)
# Example: ./get_project_git_lab_repositories.sh param1
# TOKEN="$(cat ./token.secret)" XACL="$(cat ./x-acl.secret)" ./get_project_git_lab_repositories.sh <project_sfid>
