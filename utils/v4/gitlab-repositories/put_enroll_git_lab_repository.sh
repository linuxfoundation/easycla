...
# Enrollgitlabrepository (authenticated)
# Example: ./put_enroll_git_lab_repository.sh param1
# TOKEN="$(cat ./token.secret)" XACL="$(cat ./x-acl.secret)" ./put_enroll_git_lab_repository.sh <project_sfid>
