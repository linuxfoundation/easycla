#!/bin/bash
# Get GitHub repositories for a project that are CLA enforced (authenticated)
# Usage: ./get_project_github_repositories.sh <project_sfid>
# Example: ./get_project_github_repositories.sh a01234567890123456
