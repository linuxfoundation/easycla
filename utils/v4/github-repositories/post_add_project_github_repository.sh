...
# Addprojectgithubrepository (authenticated)
# Example: ./post_add_project_github_repository.sh param1
# TOKEN="$(cat ./token.secret)" XACL="$(cat ./x-acl.secret)" ./post_add_project_github_repository.sh <project_sfid>
