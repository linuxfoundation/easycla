...
# Addprojectgitlaborganization (authenticated)
# Example: ./post_add_project_gitlab_organization.sh param1
# TOKEN="$(cat ./token.secret)" XACL="$(cat ./x-acl.secret)" ./post_add_project_gitlab_organization.sh <project_sfid>
