#!/bin/bash
# Get project list (authenticated)
# Usage: ./get_projects.sh [pageSize] [nextKey]
# Example: ./get_projects.sh 50
# TOKEN="$(cat ./token.secret)" XACL="$(cat ./x-acl.secret)" ./get_projects.sh
