...
# Download ICLA signature PDF (authenticated)
# Usage: ./download_project_icla_signature_pdf.sh <cla_group_id> <signature_id>
# Example: ./download_project_icla_signature_pdf.sh d9428888-122b-4b20-8c4a-0c9a1a6f9b8e sig123
# TOKEN="$(cat ./token.secret)" XACL="$(cat ./x-acl.secret)" ./download_project_icla_signature_pdf.sh <cla_group_id> <signature_id>
