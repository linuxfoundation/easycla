...
# Downloadprojectsignaturecorporatecla (authenticated)
# Example: ./get_download_project_signature_corporate_cla.sh param1 param2
# TOKEN="$(cat ./token.secret)" XACL="$(cat ./x-acl.secret)" ./get_download_project_signature_corporate_cla.sh <cla_group_id> <signature_id>
