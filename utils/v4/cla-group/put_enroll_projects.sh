#!/bin/bash
# PUT /cla-group/{claGroupID}/enroll-projects
# Enroll projects in a CLA Group (authenticated)
# Usage: ./put_enroll_projects.sh <cla_group_id> <project_sfid_list>
# Example: ./put_enroll_projects.sh d9428888-122b-4b20-8c4a-0c9a1a6f9b8e "a01234567890123456,a09876543210987654"
# TOKEN="$(cat ./token.secret)" XACL="$(cat ./x-acl.secret)" ./put_enroll_projects.sh <cla_group_id> <project_list>
...
API="${API_URL}/v4/cla-group/${cla_group_id}/enroll-projects"
