...
aws --profile lfproduct-dev --region us-east-2 ssm put-parameter --name "/cla-auth0-username-claim-cli-dev" --value "http://lfx.dev/claims/username" --type "String" --overwrite
aws --profile lfproduct-dev --region us-east-2 ssm put-parameter --name "/cla-auth0-email-claim-cli-dev" --value "http://lfx.dev/claims/email" --type "String" --overwrite
aws --profile lfproduct-dev --region us-east-2 ssm put-parameter --name "/cla-auth0-name-claim-cli-dev" --value "http://lfx.dev/claims/username" --type "String" --overwrite
