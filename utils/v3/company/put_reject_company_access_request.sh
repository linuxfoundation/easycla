...
# Rejectcompanyaccessrequest (authenticated)
# Example: ./put_reject_company_access_request.sh param1 param2
# TOKEN="$(cat ./token.secret)" XACL="$(cat ./x-acl.secret)" ./put_reject_company_access_request.sh <company_id> <request_id>
...
API="${API_URL}/v3/company/${company_id}/cla/accesslist/${request_id}/reject"
