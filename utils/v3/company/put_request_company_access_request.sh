...
# Requestcompanyaccessrequest (authenticated)
# Example: ./put_request_company_access_request.sh param1
# TOKEN="$(cat ./token.secret)" XACL="$(cat ./x-acl.secret)" ./put_request_company_access_request.sh <company_id>
...
API="${API_URL}/v3/company/${company_id}/cla/accesslist/request"
