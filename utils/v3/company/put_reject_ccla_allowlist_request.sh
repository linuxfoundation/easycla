...
# Rejectcclaallowlistrequest (authenticated)
# Example: ./put_reject_ccla_allowlist_request.sh param1 param2 param3
# TOKEN="$(cat ./token.secret)" XACL="$(cat ./x-acl.secret)" ./put_reject_ccla_allowlist_request.sh <company_id> <project_id> <request_id>
...
API="${API_URL}/v3/company/${company_id}/ccla-whitelist-requests/${project_id}/${request_id}/reject"
