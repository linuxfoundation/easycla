...
# Approveclamanagerrequest (authenticated)
# Example: ./put_approve_cla_manager_request.sh param1 param2 param3
# TOKEN="$(cat ./token.secret)" XACL="$(cat ./x-acl.secret)" ./put_approve_cla_manager_request.sh <company_id> <project_id> <request_id>
...
API="${API_URL}/v3/company/${company_id}/project/${project_id}/cla-manager/requests/${request_id}/approve"
