...
# Getclamanagerrequest (authenticated)
# Example: ./get_cla_manager_request.sh param1 param2 param3
# TOKEN="$(cat ./token.secret)" XACL="$(cat ./x-acl.secret)" ./get_cla_manager_request.sh <company_id> <project_id> <request_id>
