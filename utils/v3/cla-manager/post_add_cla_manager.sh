...
# Addclamanager (authenticated)
# Example: ./post_add_cla_manager.sh param1 param2
# TOKEN="$(cat ./token.secret)" XACL="$(cat ./x-acl.secret)" ./post_add_cla_manager.sh <company_id> <project_id>
...
API="${API_URL}/v3/company/${company_id}/project/${project_id}/cla-manager"
