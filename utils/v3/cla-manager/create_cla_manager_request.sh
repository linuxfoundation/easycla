#!/bin/bash
# POST /company/{companyID}/project/{projectID}/cla-manager/requests
# Createclamanagerrequest (authenticated)
# Example: ./create_cla_manager_request.sh param1 param2
# TOKEN="$(cat ./token.secret)" XACL="$(cat ./x-acl.secret)" ./create_cla_manager_request.sh <company_id> <project_id>
