...
# Getgithuborgallowlist (authenticated)
# Example: ./get_git_hub_org_allowlist.sh param1
# TOKEN="$(cat ./token.secret)" XACL="$(cat ./x-acl.secret)" ./get_git_hub_org_allowlist.sh <signature_id>
