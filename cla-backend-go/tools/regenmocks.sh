...
mockgen -copyright_file=copyright-header.txt -source=signatures/service.go -destination=signatures/mocks/mock_service.go -package=mock_signatures SignatureService
