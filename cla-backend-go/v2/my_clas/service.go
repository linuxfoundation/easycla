...
// only in the project-service and is fetched by project SFID (a multi-project, foundation-level
// CLA Group resolves to its foundation). A project-service lookup miss degrades to an empty logo
