...
// ConvertUserModelToUserCompatModel mocks base method.
func (m *MockService) ConvertUserModelToUserCompatModel(arg0 *models.User) (*models.UserCompat, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ConvertUserModelToUserCompatModel", arg0)
	ret0, _ := ret[0].(*models.UserCompat)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ConvertUserModelToUserCompatModel indicates an expected call of ConvertUserModelToUserCompatModel.
func (mr *MockServiceMockRecorder) ConvertUserModelToUserCompatModel(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ConvertUserModelToUserCompatModel", reflect.TypeOf((*MockService)(nil).ConvertUserModelToUserCompatModel), arg0)
}
...
func (mr *MockServiceMockRecorder) GetUsersByEmail(userEmail interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUsersByEmail", reflect.TypeOf((*MockService)(nil).GetUsersByEmail), userEmail)
}

// GetUsersByIdentity mocks base method.
func (m *MockService) GetUsersByIdentity(lfUsername string, emails, githubIDs []string) ([]*models.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUsersByIdentity", lfUsername, emails, githubIDs)
	ret0, _ := ret[0].([]*models.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetUsersByIdentity indicates an expected call of GetUsersByIdentity.
func (mr *MockServiceMockRecorder) GetUsersByIdentity(lfUsername, emails, githubIDs interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUsersByIdentity", reflect.TypeOf((*MockService)(nil).GetUsersByIdentity), lfUsername, emails, githubIDs)
}
...
func (mr *MockServiceMockRecorder) GetUsersByLFEmail(userEmail interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUsersByLFEmail", reflect.TypeOf((*MockService)(nil).GetUsersByLFEmail), userEmail)
}
